...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<activerecord>.freeze, ["< 4.3", ">= 4.2.0"])
      s.add_runtime_dependency(%q<activemodel>.freeze, ["< 4.3", ">= 4.2.0"])
      s.add_development_dependency(%q<database_cleaner>.freeze, ["~> 1.4.0"])
      ...
      s.add_dependency(%q<activerecord>.freeze, ["< 4.3", ">= 4.2.0"])
      s.add_dependency(%q<activemodel>.freeze, ["< 4.3", ">= 4.2.0"])
      s.add_dependency(%q<database_cleaner>.freeze, ["~> 1.4.0"])
