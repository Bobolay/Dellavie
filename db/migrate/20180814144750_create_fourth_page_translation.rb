class CreateFourthPageTranslation < ActiveRecord::Migration
  def change
    create_table :fourth_page_translations do |t|
    	t.string :main_title
     ...
     FourthPageTranslation.create_translation_table! :main_title => :string,
    ...
    def down
    	drop_table :fourth_page_translations
    	FourthPageTranslation.drop_translation_table!
    end
end